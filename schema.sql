...
CREATE TABLE IF NOT EXISTS usos_bano (
    ...
    usuario VARCHAR(50) NOT NULL,
    id_cierre INT NULL,
    INDEX idx_usos_bano_cierre (id_cierre),
    FOREIGN KEY (id_cierre) REFERENCES cierres_diarios(id_cierre)
);

-- Gastos operacionales auditables, asignados al cierre que los consolida.
...
CREATE TABLE IF NOT EXISTS print_jobs (
    ...
    estado ENUM('PENDIENTE', 'IMPRIMIENDO', 'IMPRESO', 'ERROR', 'CANCELADO', 'REVISION_MANUAL') NOT NULL DEFAULT 'PENDIENTE',

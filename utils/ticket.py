...
def generar_ticket_salida(patente, fecha_hora_ingreso, fecha_hora_salida, tarifa, subida_aplicada=False, monto_extra=0, minutos_estancia=None):
    """
    ...
    Args:
        ...
        subida_aplicada (bool): Indica si hubo subida temporal de precios.
        monto_extra (int): Monto adicional por subida temporal.
        minutos_estancia (int | None): Minutos totales de estancia. Si no se
            proporciona, se calcula automáticamente.
